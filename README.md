...
| Light         | `15.６ MB`     | `818 KB`  | `562 KB` |
| DemiLight     | `15.6 MB`      | `812 KB`  | `568 KB` |
| Regular       | `15.７ MB`     | `809 KB`  | `571 KB` |
| Medium        | `15.7 MB`      | `804 KB`  | `574 KB` |
| Bold          | `16.2 MB`      | `804 KB`  | `577 KB` |
| Black         | `17.0 MB`      | `810 KB`  | `569 KB` |
| Variable      | `29.3 MB`      | `1.54 MB` | `933 KB` |
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url('../fonts/NotoSansCJKjp-Regular.min.woff2') format('woff2'), url('../fonts/NotoSansCJKjp-Regular.min.woff')
      format('woff'),
    url('../fonts/NotoSansCJKjp-Regular.min.ttf') format('truetype');
}
```
